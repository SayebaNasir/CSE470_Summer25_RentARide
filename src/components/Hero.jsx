...
const Hero = () => {
  ...
  return (
    <div className='h-screen flex flex-col items-center justify-center gap-14 bg-light text-center'>
        <h1 className='text-4xl md:text-5xl font-semibold text-pink-800'> Cars On Rent For Your Next Adventure! </h1>
       ...
       <img src={assets.banner_car_image} alt="homepage car" className='max-h-74'/>
