  ...
  return (
    <footer className="flex flex-col bg-slate-50 items-center justify-around w-full py-16 text-sm text-gray-800/70">
      <div className="flex items-center gap-8">
        <a href="#" className="font-medium text-gray-700 hover:text-black transition-all">Home</a>
        <a href="#" className="font-medium text-gray-500 hover:text-black transition-all">About</a>
        <a href="#" className="font-medium text-gray-700 hover:text-black transition-all">Services</a>
      ...
      <p className="mt-8 text-center">
        Copyright © 2025 Rent-A-Ride, All rights reserved.
      </p>
    </footer>
  );
};
