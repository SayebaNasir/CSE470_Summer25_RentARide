    ...
    <div className='px-4 py-10 md:px-10 flex-1'>
      ...
      >
        ...
        <div className='flex items-center gap-2 w-full'>
          ...
          <p className='text-sm text-gray-500'>Upload Picture of the Car</p>
        </div>
        {/*Car Brand and Model*/}
        <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
          <div className='flex flex-col w-full'>
            <label>Brand</label>
            <input type="text" placeholder='e.g. BMW, Toyota,...' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.brand} onChange={e=> setCar({...car, brand:e.target.value})}/>
          </div>
          <div className='flex flex-col w-full'>
            <label>Model</label>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6' >
          ...
          <div className='flex flex-col w-full'>
            <label>Each Day Price ({currency})</label>
            <input type="number" placeholder='e.g. 1000, E-Class,...' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.pricePerDay} onChange={e=> setCar({...car, pricePerDay:e.target.value})}/>
          </div>
          <div className='flex flex-col w-full'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2md:grid-cols-3 gap-6'>
          <div className='flex flex-col w-full'>
        ...
        <div className='flex flex-col w-full'>
            ...
            <textarea rows={5} placeholder='e.g. A brand new car with a powerful engine.' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.description} onChange={e=> setCar({...car, description:e.target.value})}></textarea>
          </div>
