  ...
  return (
    <div className='relative min-h-screen md:flex flex-col items-center pt-8 max-w-13 md:max-w-60 w-full border-r border-borderColor text-sm'>
      ...
      <div className='group relative'>
        <label htmlFor="image">
          <img src={
              image ? URL.createObjectURL(image) : user?.image || "https://images.unsplash.com/photo-1612831455544-5a3b77c3dbfc"} alt="profile"className="w-24 h-24 rounded-full object-cover"/>
          <input
            type="file"
            id='image'
            accept="image/*"
